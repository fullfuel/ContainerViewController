...
#import "FirstCustomViewController.h"
#import "SecondCustomViewController.h"
#import "ThirdCustomViewController.h"
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    FirstCustomViewController *vc1 = [[FirstCustomViewController alloc] init];
//    CustomNavigationController *nav1 = [[CustomNavigationController alloc] initWithRootViewController:vc1];
    UINavigationController *nav1 = [[UINavigationController alloc] init];
    nav1.viewControllers = @[vc1];
    nav1.delegate = self;
    
    
    SecondCustomViewController *vc2 = [[SecondCustomViewController alloc] init];
    UINavigationController *nav2 = [[UINavigationController alloc] init];
    nav2.viewControllers = @[vc2];
    nav2.delegate = self;
    
    ThirdCustomViewController *vc3 = [[ThirdCustomViewController alloc] init];
    UINavigationController *nav3 = [[UINavigationController alloc] init];
    nav3.viewControllers = @[vc3];
    nav3.delegate = self;
    
    FourthCustomViewController *vc4 = [[FourthCustomViewController alloc] init];
...
- (NSURL *)applicationDocumentsDirectory {
    // The directory the application uses to store the Core Data store file. This code uses a directory named "bai.ContainerViewController" in the application's documents directory.
...
- (NSManagedObjectModel *)managedObjectModel {
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"ContainerViewController" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator {
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"ContainerViewController.sqlite"];
    NSError *error = nil;
